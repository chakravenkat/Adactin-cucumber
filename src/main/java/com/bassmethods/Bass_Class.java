...
"C:\\Users\\Admin\\eclipse-workspace-greens\\AdactinProject\\Chromedriver\\chromedriver.exe");			driver = new ChromeDriver();
		} else if (browsername.equalsIgnoreCase("firefox")) {
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\Admin\\eclipse-workspace-greens\\Selenium_Programs\\driver2\\geckodriver.exe");
	...
	public static void screenshot(String name) throws IOException {
		...
		File des = new File("C:\\Users\\Admin\\eclipse-workspace-greens\\Selenium_Programs\\Screenshots\\" +name+" .png");
